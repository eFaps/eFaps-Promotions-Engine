...
public class Second25PercentOffTest
{
    ...
    public void buyOneGetOneFree()
    {
        ...
        Assert.assertTrue(new BigDecimal(122).compareTo(document.getPositions().get(2).getNetPrice()) == 0);
    ...
    @Test
    public void buy2getBothForFixAmount()
    {
        final var document = new Document()
                        .addPosition(new Position()
                                        .setQuantity(new BigDecimal(1))
    ...
    @Test
    public void buy2getBothForFixAmount2()
    {
        final var document = new Document()
                        .addPosition(new Position()
                                        .setQuantity(new BigDecimal(1))
