...
public class BINCondition
    extends AbstractKeyValueCondition<BINCondition, String>
{
    public static String KEY = "BINCondition-Identifier";
    ...
    public BINCondition addIdentifier(final String identifier)
    {
    ...
    public boolean equals(final Object obj)
    {
        ...
        if (!(obj instanceof final BINCondition condition)) {
            return false;
        }
